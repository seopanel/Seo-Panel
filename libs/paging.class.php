...
class Paging
{
    ...
    public function loadPaging($result, $per_page=15)
    {
    ...
    public function printPaging($scriptArgs='')
    {
        $tmp = '';
        ...
        if (!empty($this->div_class)) {
            $div_class=' class="'.$this->div_class.'"';
        }
        $tmp .= "<div$div_class>";
        ": ";
        ": ";
    ...
    public function createPagingLink($linkText='', $linkBefore='', $linkAfter='')
    {
        if (!empty($this->link_class)) {
            $linkClass=' class="'.$this->link_class.'"';
        }
    ...
    # func to print pages
    public function printPages($scriptPath, $scriptForm='', $scriptfunction='scriptDoLoad', $showArea='content', $scriptArgs='')
    {
