...
class Mysql extends Database
{
    ...
    # constructor
    public function Mysql($dbServer, $dbUser, $dbPassword, $dbName, $debug)
    {
    ...
    public function query($query, $noRows=false)
    {
        ...
        if ($noRows) {
            $this->noRows = mysql_num_rows($res);
        }
        return $res;
    }

    # func to get max id of a table
    public function getMaxId($table, $col='id')
    {
    ...
    public function importDatabaseFile($filename)
    {
