 ...
 */
 ...
 {
     /* Palettes definition */
   public $Palette = array("0"=>array("R"=>188,"G"=>224,"B"=>46),
   ...
   public $ErrorReporting = false;
     ...
     public $Errors         = null;
     public $ErrorFontName  = "fonts/tahoma.ttf";
   ...
   public $AntialiasQuality = 10;

   /* This function create the background picture */
   public function pChart($XSize, $YSize)
   {
       $this->XSize   = $XSize;
       $this->YSize   = $YSize;
  ...
  public function setLineStyle($Width=1, $DotSize=0)
  {
   ...
   public function drawGraphArea($R, $G, $B, $Stripe=false)
   {
...
// * Fixed in 1.27 *         { $X2 = $this->GArea_X2 - 1; $Y2 = $this->GArea_Y2 - ($this->GArea_X2 - $X1); }
   ...
   public function drawScale(&$Data, &$DataDescription, $ScaleMode, $R, $G, $B, $DrawTicks=true, $Angle=0, $Decimals=1, $WithMargin=false, $SkipLabels=1)
   {
   ...
   /* Compute and draw the scale */
   public function drawGrid($LineWidth, $Mosaic=true, $R=220, $G=220, $B=220, $Alpha=100)
   {
       /* Draw mosaic */
     if ($Mosaic) {
   ...
   public function drawLegend($XPos, $YPos, &$DataDescription, $R, $G, $B)
   {
       /* Validate the Data and DataDescription array */
   ...
   /* Draw the data legends */
   public function drawPieLegend($XPos, $YPos, &$Data, &$DataDescription, $R, $G, $B)
   {
       /* Validate the Data and DataDescription array */
   ...
   /* Compute and draw the scale */
   public function drawTreshold($Value, $R, $G, $B, $ShowLabel=false, $ShowOnRight=false, $TickWidth=4)
   {
       if ($R < 0) {
           $R = 0;
       }
   ...
   public function setLabel(&$Data, &$DataDescription, $SerieName, $ValueName, $Caption, $R=210, $G=210, $B=210)
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawPlotGraph(&$Data, &$DataDescription, $BigRadius=5, $SmallRadius=2, $R2=-1, $G2=-1, $B2=-1)
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawArea(&$Data, $Serie1, $Serie2, $R, $G, $B, $Alpha = 50)
   {
       /* Validate the Data and DataDescription array */
   ...
   public function writeValues(&$Data, &$DataDescription, $Series)
   {
       /* Validate the Data and DataDescription array */
   ...
   /* This function draw a line graph */
   public function drawLineGraph(&$Data, &$DataDescription, $SerieName="")
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawCubicCurve(&$Data, &$DataDescription, $Accuracy=.1, $SerieName="")
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawFilledCubicCurve(&$Data, &$DataDescription, $Accuracy=.1, $Alpha=100, $AroundZero=false)
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawFilledLineGraph(&$Data, &$DataDescription, $Alpha=100, $AroundZero=false)
   {
       $Empty = -2147483647;
   ...
   public function drawOverlayBarGraph(&$Data, &$DataDescription, $Alpha=50)
   {
       /* Validate the Data and DataDescription array */
   ...
   /* This function draw a bar graph */
   public function drawBarGraph(&$Data, &$DataDescription, $Shadow=false, $Alpha=100)
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawStackedBarGraph(&$Data, &$DataDescription, $Alpha=50)
   {
       /* Validate the Data and DataDescription array */
     $this->validateDataDescription("drawBarGraph", $DataDescription);
       $this->validateData("drawBarGraph", $Data);
   ...
   public function drawLimitsGraph(&$Data, &$DataDescription, $R=0, $G=0, $B=0)
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawRadarAxis(&$Data, &$DataDescription, $Mosaic=true, $BorderOffset=10, $A_R=60, $A_G=60, $A_B=60, $S_R=200, $S_G=200, $S_B=200, $MaxValue=-1)
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawRadar(&$Data, &$DataDescription, $BorderOffset=10, $MaxValue=-1)
   {
       /* Validate the Data and DataDescription array */
   ...
   /* This function draw a radar graph centered on the graph area */
   public function drawFilledRadar(&$Data, &$DataDescription, $Alpha=50, $BorderOffset=10, $MaxValue=-1)
   {
       /* Validate the Data and DataDescription array */
   ...
   /* This function draw a flat pie chart */
   public function drawFlatPieGraph(&$Data, &$DataDescription, $XPos, $YPos, $Radius=100, $DrawLabels=PIE_NOLABEL, $SpliceDistance=0, $Decimals = 0)
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawPieGraph(&$Data, &$DataDescription, $XPos, $YPos, $Radius=100, $DrawLabels=PIE_NOLABEL, $EnhanceColors=true, $Skew=60, $SpliceHeight=20, $SpliceDistance=0, $Decimals=0)
   {
       /* Validate the Data and DataDescription array */
   ...
   public function drawBackground($R, $G, $B)
   {
       if ($R < 0) {
           $R = 0;
       }
   ...
   public function drawFilledRectangle($X1, $Y1, $X2, $Y2, $R, $G, $B, $DrawBorder=true, $Alpha=100)
   {
       if ($R < 0) {
           $R = 0;
       }
   ...
   public function drawRoundedRectangle($X1, $Y1, $X2, $Y2, $Radius, $R, $G, $B)
   {
       if ($R < 0) {
           $R = 0;
       }
   ...
   public function drawFilledRoundedRectangle($X1, $Y1, $X2, $Y2, $Radius, $R, $G, $B)
   {
       if ($R < 0) {
           $R = 0;
       }
   ...
   public function drawCircle($Xc, $Yc, $Height, $R, $G, $B, $Width=0)
   {
       if ($Width == 0) {
           $Width = $Height;
       }
   ...
   public function drawFilledCircle($Xc, $Yc, $Height, $R, $G, $B, $Width=0)
   {
       if ($Width == 0) {
           $Width = $Height;
       }
   ...
   /* Color helper */
   public function AllocateColor($Picture, $R, $G, $B, $Factor=0)
   {
       $R = $R + $Factor;
       $G = $G + $Factor;
       $B = $B + $Factor;
   ...
   public function drawAntialiasPixel($X, $Y, $R, $G, $B)
   {
       if ($R < 0) {
           $R = 0;
       }
   ...
   public function validateDataDescription($FunctionName, &$DataDescription, $DescriptionRequired=true)
   {
       if (!isset($DataDescription["Position"])) {
   ...
   public function validateData($FunctionName, &$Data)
   {
       $DataSummary = "";
   ...
   public function printErrors($Mode="CLI")
   {
