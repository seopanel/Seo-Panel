...
class Spider
{
    ...
    public $_CURL_RESOURCE = null;
    public $_CURLOPT_FAILONERROR = false;
    public $_CURLOPT_FOLLOWLOCATION = true;
    public $_CURLOPT_RETURNTRANSFER = true;
    public $_CURLOPT_TIMEOUT = 15;
    public $_CURLOPT_POST = true;
    public $_CURLOPT_POSTFIELDS = null;
    public $_CURLOPT_USERAGENT = "Mozilla/5.0 (Windows; U; MSIE 9.0; WIndows NT 9.0; en-US))";
    public $_CURLOPT_USERPWD = null;
    public $_CURLOPT_COOKIEJAR = '';
    public $_CURLOPT_COOKIEFILE = '';
    public $_CURLOPT_REFERER = "";
    public $_CURL_sleep = 1;
    public $_CURLOPT_COOKIE = "";
    public $_CURLOPT_HEADER = 0;
    public $_CURL_HTTPHEADER = array();
    public $userAgentList = array();
    ...
    public function getPageInfo($url, $domainUrl, $returnUrls=false)
    {
    ...
    public function getUniqueUrls($url)
    {
    ...
    public function __getTagParam($param, $tag)
    {
    ...
    public function getContent($url, $enableProxy=true, $logCrawl = true)
    {
    ...
    # func to check proxy 
    public function checkProxy($proxyInfo)
    {
        $this->_CURLOPT_USERAGENT = defined('SP_USER_AGENT') ? SP_USER_AGENT : $this->_CURLOPT_USERAGENT;
        $ch = curl_init();
