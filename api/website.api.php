...
class WebsiteAPI extends Seopanel
{
     ...
     */
    public function getFormattedReport($websiteInfo, $fromTime, $toTime)
    {
     ...
     */
    public function getWebsiteInfo($info)
    {
     ...
     * @return Array $returnInfo  	Contains details about the operation succes or not
     */
    public function updateWebsite($info)
    {
        $websiteId = intval($info['id']);
     ...
     */
    public function deleteWebsite($info)
    {
        $websiteId = intval($info['id']);
