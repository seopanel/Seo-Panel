...
class KeywordAPI extends Seopanel
{
     ...
     */
    public function getFormattedReport($keywordInfo, $fromTime, $toTime)
    {
     ...
     */
    public function getReportById($info)
    {
     ...
     * @return Array $returnInfo  	Contains informations about keyword reports
     */
    public function getReportByWebsiteId($info)
    {
     ...
     * @return Array $returnInfo  	Contains informations about keyword reports
     */
    public function getReportByUserId($info)
    {
     ...
     */
    public function getKeywordInfo($info)
    {
     ...
     */
    public function createKeyword($info)
    {
     ...
     * @return Array $returnInfo  	Contains details about the operation succes or not
     */
    public function updateKeyword($info)
    {
        $keywordId = intval($info['id']);
     ...
     * @return Array $returnInfo  	Contains details about the operation succes or not
     */
    public function deleteKeyword($info)
    {
        $keywordId = intval($info['id']);
