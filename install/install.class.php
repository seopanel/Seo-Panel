...
class Install
{
    ...
    public function checkRequirements($error=false)
    {
        $phpClass = "red";
        $phpSupport = "No";
		...
		<table width="100%" cellspacing="8px" cellpadding="0px" class="formtab">
			...
			<tr><td colspan="2" class="error"><?php echo $errMsg;
        ?></td></tr>
			<tr>
				<th>PHP version >= 4.0.0</th>
				<td class="<?php echo $phpClass;
        ?>"><?php echo $phpSupport;
        ?></td>
			</tr>
			<tr>
				<th>MySQL Support</th>
				<td class="<?php echo $mysqlClass;
        ?>"><?php echo $mysqlSupport;
        ?></td>
			</tr>
			<tr>
				<th>CURL Support</th>
				<td class="<?php echo $curlClass;
        ?>"><?php echo $curlSupport;
        ?></td>
			</tr>
			<?php /* ?>
            <tr>
			...
			<tr>
				...
				<td class="<?php echo $gdClass;
        ?>"><?php echo $gdSupport;
        ?></td>
			</tr>
			<tr>
				<th>/config/sp-config.php</th>
				<td class="<?php echo $configClass;
        ?>"><?php echo $configSupport;
        ?></td>
			</tr>
			<tr>
				<th>/tmp</th>
				<td class="<?php echo $tmpClass;
        ?>"><?php echo $tmpSupport;
        ?></td>
			</tr>
		</table>
		<input type="hidden" value="<?php echo $phpClass;
        ?>" name="php_support">
		<input type="hidden" value="<?php echo $mysqlClass;
        ?>" name="mysql_support">
		<input type="hidden" value="<?php echo $curlClass;
        ?>" name="curl_support">
		<?php /* ?><input type="hidden" value="<?php echo $shorttagClass;?>" name="short_open_tag"><?php */ ?>
		<input type="hidden" value="<?php echo $configClass;
        ?>" name="config">
    ...
    public function startInstallation($info='', $errMsg='')
    {
        ...
        ?></td></tr>
			...
			<tr>
				...
				<td><input type="text" name="db_host" value="<?php echo empty($info['db_host']) ? "localhost" : $info['db_host'];
        ?>"></td>
			</tr>
			<tr>
				<th>Database name:</th>
				<td><input type="text" name="db_name" value="<?php echo $info['db_name'];
        ?>"></td>
			</tr>
			<tr>
				<th>Database username:</th>
				<td><input type="text" name="db_user" value="<?php echo $info['db_user'];
        ?>"></td>
			</tr>
			<tr>
				<th>Database password:</th>
				<td><input type="text" name="db_pass" value="<?php echo $info['db_pass'];
        ?>"></td>
			</tr>
			<tr>
				<th>Admin email address:</th>
				<td><input type="text" name="email" value="<?php echo $info['email'];
        ?>"></td>
			</tr>
		</table>		
    ...
    public function writeConfigFile($info)
    {
    ...
    public function proceedInstallation($info)
    {
        $db = new DB();
		...
		<table width="100%" cellspacing="8px" cellpadding="0px" class="formtab">
			...
			<tr>
				<td style="border: none;" colspan="2">
					<ul class="list">
						<li> Please change permission of config file <b><?php echo SP_CONFIG_FILE;
    ...
    public function checkUpgradeRequirements($error=false, $errorMsg='')
    {
        $phpClass = "red";
        $phpSupport = "No";
        $phpVersion = phpversion();
		...
		<input type="hidden" value="<?php echo $configClass;
        ?>" name="config">
		<input type="hidden" value="<?php echo $dbClass;
        ?>" name="db_support">
    ...
    public function proceedUpgrade($info='')
    {
        if (($info['php_support'] == 'red') || ($info['mysql_support'] == 'red') || ($info['curl_support'] == 'red')
        ...
        ?>">
		<h1 class="BlockHeader">Success Seo Panel v.<?php echo SP_INSTALLED;
        ?> Upgrade</h1>
		<table width="100%" cellspacing="8px" cellpadding="0px" class="formtab">
    ...
    public function showDefaultFooter($content='')
    {
        ?>
				</div>
			</body>
    ...
    public function createSeoPanelAPIKey($db)
    {
