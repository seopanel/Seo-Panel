...
$controller->spTextReview = $controller->getLanguageTexts('review', $_SESSION['lang_code']);
$controller->set('spTextReview', $controller->spTextReview);
...
if(!empty($_SERVER['REQUEST_METHOD'])) {
	switch($_REQUEST['sec']) {
		default:
			$controller->showReviewDashboard($_REQUEST);
			break;
	}
}
?>
