...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch($_POST['sec']){
        ...
        case "delete":
            $controller->verifyActionAllowed($_POST['id']);
            $controller->deleteReviewLink($_POST['id']);
            break;
    ...
    switch($_GET['sec']) {
        ...
        case "edit":
            // previously the only single-target review-link action with no
            // ownership check at all - a non-admin could view another
            // user's review link name/url/type via the edit form
