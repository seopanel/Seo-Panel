...
class KeywordController extends Controller
{
    ...
    public function listKeywords($info='')
    {
        $userId = isLoggedIn();
    ...
    public function showKeywordSelectBox($userId='', $websiteId='', $keywordId='')
    {
    ...
    public function __changeStatus($keywordId, $status)
    {
    ...
    # func to change status
    public function __deleteKeyword($keywordId)
    {
        $keywordId = intval($keywordId);
    ...
    public function createKeyword($listInfo, $apiCall = false)
    {
        $userId = isLoggedIn();
        ...
        if (!is_array($listInfo['searchengines'])) {
            $listInfo['searchengines'] = array();
        }
    ...
    public function createImportedKeywords($listInfo)
    {
        $userId = isLoggedIn();
        $this->set('post', $listInfo);
    ...
    public function __checkName($name, $websiteId)
    {
    ...
    public function __getAllKeywords($userId='', $websiteId='', $isAdminCheck=false, $orderByWeb=false, $orderByValue='ASC', $searchName = '')
    {
    ...
    public function __getKeywordInfo($keywordId)
    {
        $keywordId = intval($keywordId);
    ...
    public function editKeyword($keywordId, $listInfo='')
    {
        $userId = isLoggedIn();
        $websiteController = new WebsiteController();
        $this->set('websiteList', $websiteController->__getAllWebsites($userId, true));
    ...
    public function updateKeyword($listInfo, $apiCall = false)
    {
        $userId = isLoggedIn();
        $this->set('post', $listInfo);
        $errMsg['name'] = formatErrorMsg($this->validate->checkBlank($listInfo['name']));
    ...
    public function showKeywordReports($keywordId)
    {
        $keywordId = intval($keywordId);
    ...
    public function validateKeywordCount($userId, $newCount = 1)
    {
