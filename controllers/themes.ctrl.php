...
class ThemesController extends Controller
{
    ...
    public function __getAllThemes()
    {
    ...
    # func to list  tools
    public function listThemes($msg='', $error=false)
    {
        if (empty($msg)) {
            $this->__updateAllThemes();
        }
    ...
    public function __changeInstallStatus($themeId, $status)
    {
        $themeId = intval($themeId);
    ...
    public function __getThemeInfo($val, $col='id')
    {
    ...
    public function listThemeInfo($themeId)
    {
        $themeId = intval($themeId);
    ...
    public function updateThemeInfo($themeId, $themeInfo)
    {
        $themeId = intval($themeId);
    ...
    public function upgradeTheme($themeId)
    {
    ...
    public function reInstallTheme($themeId)
    {
        $themeInfo = $this->__getThemeInfo($themeId);
    ...
    public function isThemeDirectory($file)
    {
    ...
    public function __updateAllThemes()
    {
    ...
    public function parseThemeInfoFile($file)
    {
        $themeInfo = array();
