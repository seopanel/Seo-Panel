...
class SeoPluginsController extends Controller
{
    ...
    public $info = array();
    public $pluginText = "";
    public $pluginCtrler = false;
    
    # function to manage seo plugins
    public function manageSeoPlugins($info, $method='get')
    {
    ...
    public function initPlugin($data)
    {
        return;
    }

    # func to load plugin css files
    public function loadAllPluginCss()
    {
    ...
    public function loadAllPluginJs()
    {
    ...
    # index function
    public function showSeoPlugins($info='')
    {
        $this->layout = "default";
    ...
    public function __getAllSeoPlugins()
    {
    ...
    public function listSeoPlugins($msg='', $error=false)
    {
        if (empty($msg)) {
            $this->__updateAllSeoPlugins();
        }
        $userId = isLoggedIn();
        $this->set('msg', $msg);
    ...
    public function changeStatus($seoPluginId, $status)
    {
    ...
    public function __changeInstallStatus($seoPluginId, $status)
    {
        $status = intval($status);
        $seoPluginId = intval($seoPluginId);
    ...
    public function __getSeoPluginInfo($val, $col='id')
    {
    ...
    public function editSeoPlugin($info, $error=false)
    {
        if ($error) {
            $this->set('post', $info);
        } else {
    ...
    public function listPluginInfo($pluginId)
    {
    ...
    public function updateSeoPlugin($listInfo)
    {
    ...
    public function updatePluginInfo($pluginId, $pluginInfo)
    {
        $pluginId = intval($pluginId);
        $sql = "update seoplugins set
    ...
    public function upgradeSeoPlugin($pluginId)
    {
    ...
    public function reInstallSeoPlugin($pluginId)
    {
        $pluginInfo = $this->__getSeoPluginInfo($pluginId);
    ...
    public function isPluginDirectory($file)
    {
    ...
    public function __updateAllSeoPlugins()
    {
    ...
    public function parsePluginInfoFile($file)
    {
        $pluginInfo = array();
    ...
    public function getPluginLanguageTexts($category, $langCode='en', $table='')
    {
        $langTexts = array();
    ...
    public function setPluginTextsForRender($category='', $table='')
    {
    ...
    public function isPluginActive($value, $col = 'name')
    {
    ...
    public function createPluginObject($pluginName)
    {
