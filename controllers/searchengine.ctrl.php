...
class SearchEngineController extends Controller
{
    ...
    public function __getAllSearchEngines()
    {
    ...
    public function __getsearchEngineInfo($seId)
    {
    ...
    # func to get all search engines
    public function __getAllCrawlFormatedSearchEngines()
    {
        $sql = "select * from searchengines where status=1";
    ...
    public function __changeStatus($seId, $status)
    {
        $seId = intval($seId);
    ...
    public function __deleteSearchEngine($seId)
    {
        $seId = intval($seId);
    ...
    public function isCaptchInSearchResults($searchContent)
    {
        $captchFound = false;
