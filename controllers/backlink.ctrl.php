...
{
    public $url;
    public $colList = array('google' => 'google', 'alexa' => 'alexa', 'msn' => 'msn');
    public $backUrlList = array(
    ...
    public function findBacklink($searchInfo)
    {
    ...
    public function printBacklink($backlinkInfo)
    {
    ...
    public function __getBacklinks($engine)
    {
    ...
    public function __getWebsitebacklinkReport($websiteId, $fromTime, $toTime)
    {
