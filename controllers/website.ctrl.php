...
class WebsiteController extends Controller
{
    ...
    public function listWebsites($info='')
    {
        $userId = isLoggedIn();
    ...
    public function __getAllWebsites($userId = '', $isAdminCheck = false, $searchName = '')
    {
    ...
    # func to get all Websites
    public function __getCountAllWebsites($userId='', $statusCheck = true, $statusVal = 1)
    {
    ...
    public function __getAllWebsitesWithActiveKeywords($userId='', $isAdminCheck=false)
    {
    ...
    public function __changeStatus($websiteId, $status)
    {
    ...
    public function __deleteWebsite($websiteId)
    {
        $websiteId = intval($websiteId);
    ...
    public function newWebsite($info='')
    {
        $userId = isLoggedIn();
    ...
    public function __checkName($name, $userId)
    {
    ...
    public function __checkWebsiteUrl($url, $websiteId=0)
    {
    ...
    public function createWebsite($listInfo, $apiCall = false)
    {
    ...
    public function __getWebsiteInfo($websiteId)
    {
        $websiteId = intval($websiteId);
    ...
    public function editWebsite($websiteId, $listInfo='')
    {
        $websiteId = intval($websiteId);
        if (!empty($websiteId)) {
            if (empty($listInfo)) {
    ...
    public function updateWebsite($listInfo, $apiCall = false)
    {
    ...
    public function addInputValue($value, $col)
    {
		...
		<script type="text/javascript">
			document.getElementById('<?php echo $col;
    ...
    public function showImportWebsites()
    {
        $userId = isLoggedIn();
    ...
    public function setValidationMessageForLimit($userId)
    {
    ...
    public function importWebsiteFromCsv($info)
    {
    ...
    public function importWebsite($wInfo, $userId)
    {
        $status = 'invalid';
    ...
    public function validateWebsiteCount($userId, $newCount = 1)
    {
        $userCtrler = new UserController();
