...
class RankController extends Controller
{
    ...
    public function showQuickRankChecker()
    {
        $this->render('rank/showquickrank');
    }
    
    public function findQuickRank($searchInfo)
    {
    ...
    public function printGooglePageRank($url)
    {
    ...
    public function __getGooglePageRank($url)
    {
    ...
    public function printAlexaRank($url)
    {
    ...
    public function printAlexaRankImg($alexaRank)
    {
    ...
    # alexa_rank
    public function __getAlexaRank($url)
    {
        if (SP_DEMO && !empty($_SERVER['REQUEST_METHOD'])) {
            return 0;
        }
    ...
    public function __getWebsiteRankReport($websiteId, $fromTime, $toTime)
    {
