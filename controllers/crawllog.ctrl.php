...
class CrawlLogController extends Controller
{
     ...
     */
    public function updateCrawlLog($logId, $crawlInfo)
    {
     ...
     */
    public function listCrawlLog($info = '')
    {
        $userId = isLoggedIn();
     ...
     */
    public function deleteCrawlLog($logId)
    {
     ...
     */
    public function getCrawlLogInfo($logId)
    {
     ...
     * @param int $logId	The id of the log needs to be dispalyed
     */
    public function showCrawlLogDetails($logId)
    {
     ...
     */
    public function clearCrawlLog($daysBefore)
    {
