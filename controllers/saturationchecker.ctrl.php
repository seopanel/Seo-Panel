...
{
    public $url;
    public $colList = array('google' => 'google', 'msn' => 'msn');
    public $saturationUrlList = array(
        'google' => 'http://www.google.com/search?hl=en&q=site%3A',
        'msn' => 'http://www.bing.com/search?setmkt=en-us&q=site%3A',
    );
    
    public function showSaturationChecker()
    {
        $this->render('saturationchecker/showsaturationchecker');
    }
    
    public function findSearchEngineSaturation($searchInfo)
    {
    ...
    public function printSearchEngineSaturation($saturationInfo)
    {
    ...
    public function __getSaturationRank($engine)
    {
    ...
    public function saveRankResults($matchInfo, $remove=false)
    {
    ...
    public function isReportsExists($websiteId, $time)
    {
    ...
    public function __getWebsiteSaturationReport($websiteId, $fromTime, $toTime)
    {
