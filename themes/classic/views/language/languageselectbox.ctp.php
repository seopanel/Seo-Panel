<?php $langStyle = empty($langStyle) ? 200 : $langStyle; ?>  
<select name="lang_code" id="lang_code" style="width:<?php echo $langStyle?>px;" onchange="<?php echo $onChange?>" class="custom-select">
	<?php if($langNull){ ?>
