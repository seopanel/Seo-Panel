    ...
    if (count($userList) > 0) {
        ...
        foreach ($userList as $i => $userInfo) {
			...
			<tr class="<?php echo $class?>">				
				...
				<td class="td_br_right left"><?php echo formatDate($userInfo['expiry_date']);
            ?></td>
				<td class="td_br_right"><?php echo $userInfo['status'] ? $spText['common']["Active"] : $spText['common']["Inactive"];
            ?></td>
