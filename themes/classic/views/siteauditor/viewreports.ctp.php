...
<table class="search">
	<tr>
		...
		<td>
			<select name="report_type" id="report_type" onchange="<?php echo $submitJsFunc?>" class="custom-select">
	...
	<tr>
		...
		<td>
			<select name="pagerank" onchange="<?php echo $submitJsFunc?>" class="custom-select">
				<option value="-1">-- <?php echo $spText['common']['Select']?> --</option>
				<?php for($i=0;$i<=10;$i++) {?>
