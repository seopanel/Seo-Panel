...
if (!empty($keywordPos)) {
    ...
    foreach ($seList as $i => $seInfo) {
        ...
        if (($i+1) == $seCount) {
            ?>
    				<td class="right"><?php echo $linkName;
            ?></td>
    				<?php	
        } else {
            ?>
        ...
        foreach ($indexList as $keywordId => $rankValue) {
            ...
            ?>
    			<tr class="<?php echo $class?>">				
    				<?php if (empty($websiteId)) {
    ?>
    					<td class="<?php echo $leftBotClass?> left" width='250px;'><?php echo $listInfo['weburl'];
    ?></td>
    					<td class='td_br_right left'><?php echo $listInfo['name'] ?></td>
    				<?php 
} else {
    ?>
    					<td class="<?php echo $leftBotClass?> left" width='100px;'><?php echo $listInfo['name'];
    ?></td>
    				<?php 
}
            ?>				
                    ...
                    foreach ($seList as $index => $seInfo) {
                        ...
                        if (($index+1) == $seCount) {
                            ?>
    						<td class="<?php echo $rightBotClass?>" style='width:100px' nowrap><?php echo "$rankLink $graphLink $rankDiff";
                            ?></td>	
    						<?php	
                        } else {
                            ?>
    						<td class='td_br_right' style='width:100px' nowrap><?php echo "$rankLink $graphLink $rankDiff";
                            ?></td>
    						<?php
...
<div>
    ...
    ?>
    				<tr>
    					...
    					<td class="content">
    						<?php echo $websiteInfo['name'];
    ?><br>
    						<a href="<?php echo $websiteInfo['url'];
    ?>" target="_blank"><?php echo $websiteInfo['url'];
    ?></a>
    					</td>
    					<td class="content"><a href="<?php echo $rankLink?>"><?php echo $websiteInfo['googlerank'];
    ?></a></td>
    					<td class="content"><a href="<?php echo $rankLink?>"><?php echo $websiteInfo['alexarank'];
    ?></a></td>
    					<td class="content"><a href="<?php echo $backlinkLink?>"><?php echo $websiteInfo['google']['backlinks'];
    ?></a></td>
    					<td class="content"><a href="<?php echo $backlinkLink?>"><?php echo $websiteInfo['alexa']['backlinks'];
    ?></a></td>
    					<td class="content"><a href="<?php echo $backlinkLink?>"><?php echo $websiteInfo['msn']['backlinks'];
    ?></a></td>
    					<td class="content"><a href="<?php echo $indexedLink?>"><?php echo $websiteInfo['google']['indexed'];
    ?></a></td>				
    					<td class="content"><a href="<?php echo $indexedLink?>"><?php echo $websiteInfo['msn']['indexed'];
    ?></a></td>
    					<td class="contentmid"><a href="<?php echo $totaldirLink?>"><?php echo $websiteInfo['dirsub']['total'];
    ?></a></td>					
    					<td class="contentmid"><a href="<?php echo $activeDirLink?>"><?php echo $websiteInfo['dirsub']['active'];
    ?></a></td>
    				</tr> 
    			<?php 
}
