...
<div class="cron-container">
    <div class="cron-header">
        ...
        <div class="cron-header-text">
            <h2><?php echo $spTextPanel['Site Auditor Cron Setup'] ?? 'Site Auditor Cron Setup'?></h2>
            <p><?php echo $spTextPanel['Automate your site auditing with scheduled cron jobs'] ?? 'Automate your site auditing with scheduled cron jobs'?></p>
        </div>
    </div>
    ...
    <div class="cron-card">
        <div class="cron-card-title">
            ...
            <?php echo $spTextPanel['Add following command to your cron tab'] ?? 'Add the following command to your crontab'?>
        </div>

        <?php $command = "*/15 * * * * php ".SP_ABSPATH."/siteauditorcron.php"; ?>
        ...
        <div class="cron-info-grid">
            ...
            <div class="cron-info-item success">
                ...
                <div class="cron-info-value"><?php echo SP_ABSPATH; ?>/siteauditorcron.php</div>
            </div>
        </div>
    </div>
        ...
        <table class="cron-schedule-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><code>*/15 * * * *</code></td>
                    <td><?php echo $spTextPanel['Recommended for active sites'] ?? 'Recommended for active sites'?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><code>0 * * * *</code></td>
                    <td><?php echo $spTextPanel['For low-traffic sites'] ?? 'For low-traffic sites'?></td>
                </tr>
                <tr>
