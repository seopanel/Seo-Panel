...
<table class="search" style="width: 60%">
	<tr>
		...
		<td>
			<select name="website_id" class="custom-select" onchange="scriptDoLoad('aivisibility.php?sec=overview', 'content', '&website_id='+this.value)">
...
<div style="display:grid;grid-template-columns:repeat(3, 1fr);gap:20px;margin-bottom:24px;">
	<div class="aiv-card" style="text-align:center;margin-bottom:0;padding:22px;">
		...
		<div style="font-size:13px;color:#8a8ea3;font-weight:600;margin-top:4px;"><?php echo $spTextAIV['AI Referrals (30 days)'] ?? 'AI Referrals (30 days)'?></div>
	</div>
	<div class="aiv-card" style="text-align:center;margin-bottom:0;padding:22px;">
		...
		<div style="font-size:13px;color:#8a8ea3;font-weight:600;margin-top:4px;"><?php echo $spTextAIV['AI Bot Crawls (30 days)'] ?? 'AI Bot Crawls (30 days)'?></div>
	</div>
	<div class="aiv-card" style="text-align:center;margin-bottom:0;padding:22px;">
...
<?php } else { ?>
	<div class="aiv-card">
		<div class="aiv-card-header">
			...
			<div>
				<div class="aiv-card-title"><?php echo $spTextAIV['Top AI Platforms (30 days)'] ?? 'Top AI Platforms (30 days)'?></div>
			</div>
		</div>
