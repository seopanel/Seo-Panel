    ...
    if (count($list) > 0) {
        ...
        foreach ($list as $i => $listInfo) {
			...
			<tr class="<?php echo $class?>">
				...
				<td class="td_br_right left"><a target="_blank" href="<?php echo $listInfo['submit_url']?>"><?php echo str_replace('http://', '', $listInfo['domain']);
            ?></a></td>
				<td class="td_br_right" id="pr_<?php echo $listInfo['id']?>"><?php echo $listInfo['google_pagerank']?></td>
				<td class="td_br_right" id="captcha_<?php echo $listInfo['id']?>"><?php echo $listInfo['is_captcha'] ? $spText['common']["Yes"] : $spText['common']["No"];
            ?></td>
				<td class="td_br_right"><?php echo $listInfo['lang_name']?></td>
				<td class="td_br_right" id="status_<?php echo $listInfo['id']?>"><?php echo $statusLink;
            ?></td>
				<td class="<?php echo $rightBotClass?>" width="100px"><?php echo $checkLink;
            ?></td>
			</tr>
			<?php
